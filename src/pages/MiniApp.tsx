                ...
                <>
                  <ul className="space-y-1">
                    {txs.slice(0, txVisible).map((tx: any) => {
                      ...
                      const isWithdrawal = sub === "withdrawal_request" || sub === "withdrawal_paid" || sub === "withdrawal_rejected";
                      ...
                      return (
                        <li key={tx.id}
                          ...
                          <div className={`w-8 h-8 rounded-lg border flex items-center justify-center shrink-0 ${
                            ...
                            <Icon className={`w-3.5 h-3.5 ${isWithdrawal ? "text-emerald-300" : negative ? "text-orange-300" : "text-white/70"}`} />
                          </div>
                          <div className="flex-1 min-w-0">
                          ...
                          <div className={`text-[13px] font-medium tabular-nums shrink-0 ${
                            isWithdrawal ? "text-emerald-300" : negative ? "text-orange-300" : "text-white"
                          }`}>
