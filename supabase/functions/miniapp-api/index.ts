    ...
    switch (action) {
      ...
      case "verify_task": {
        ...
        if (task.type === "subscribe") {
          ...
          const botToken = Deno.env.get("new_TELEGRAM_Api_token") || Deno.env.get("TELEGRAM_BOT_TOKEN_V2") || Deno.env.get("TELEGRAM_BOT_TOKEN_NEW") || Deno.env.get("TELEGRAM_BOT_TOKEN");
